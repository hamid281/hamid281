...
# تنظیمات
TOKEN = os.getenv('7708534005:AAHxcmWAs82atcdiNLwuPw_3CDX_3A_hIfs')  # توکن باید در محیط تنظیم شود
...
MESSAGES = {
    ...
    "payment_info": "💳 راهنمای پرداخت:\n1. مبلغ را به شماره کارت زیر واریز کنید:\n{}\n2. شماره فیش پرداختی را برای ما ارسال کنید".format(MY_CARD)
}
...
def main():
    ...
    application.add_handler(MessageHandler(filters.TEXT & filters.Regex("^💳 راهنمای پرداخت$"), show_payment_info))
